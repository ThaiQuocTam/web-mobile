                        ...
                        <div className='p-3'>
                            <div className='pl-3 pt-2 rounded-5 border border-gray-300'>
                                <div className='px-2 pb-3 mt-1'>
                                    ...
                                    />
                                    {
                                        errors.Ten_san_pham && <span className="text-red-500 text-3 italic">Vui lòng nhập tên tài khoản </span>
                                    }
                                </div>
                                <div className='px-2 pb-3 mt-1'>
                                    <input
                                    ...
                                    />
                                    {
                                        errors.Ten_san_pham && <span className="text-red-500 text-3 italic">Vui lòng nhập Họ tên </span>
                                    }
                                </div>
                                ...
                                <div className='px-2 pb-3 mt-1'>
                                    ...
                                    />
                                    {
                                        errors.Ten_san_pham && <span className="text-red-500 text-3 italic">Vui lòng nhập mật khẩu </span>
                                    }
                                </div>
                                ...
                                <div className='px-2 pb-3 mt-1'>
                                    ...
                                    />
                                    {
                                        errors.Ten_san_pham && <span className="text-red-500 text-3 italic">Vui lòng nhập nhập lại mật khẩu </span>
                                    }
                                </div>
                                <div className='px-2 pb-3 mt-1'>
                                    <input
                                    ...
                                    />
                                    {
                                        errors.Ten_san_pham && <span className="text-red-500 text-3 italic">Vui lòng nhập Email </span>
                                    }
                                </div>

                                <div className='flex px-2 pb-3 mt-1'>
                                    <label className='inline-block w-1/2 text-gray-900 text-3.5 font-semibold'>Giới tính : </label>
                                    <select
                                ...
                                <div className='px-2 pb-3 mt-1'>
                                    <input
                                        type='number'
                                        className='w-full shadow-soft-xxs placeholder:text-gray-500 text-3.5 border-2 rounded-2  focus:outline-none focus:border-red-200 hover:border-slate-200 border-slate-100 pl-5 py-2 text-slate-800 font-medium' placeholder='Số điện thoại'
                                        {...register('So_luong_SP', { required: true })}
                                    />
                                    {
                                        errors.So_luong_SP && <span className="text-red-500 text-3 italic">Vui lòng nhập số điện thoại </span>
                                    }
                                </div>
